...
static char normfgcolor[]                = "#c8d3f5";
static char normbgcolor[]                = "#222436";
static char normbordercolor[]            = "#444A73";
static char normfloatcolor[]             = "#444A73";

static char selfgcolor[]                 = "#FFFFFF";
static char selbgcolor[]                 = "#444a73";
static char selbordercolor[]             = "#C45DE6";
static char selfloatcolor[]              = "#C45DE6";
...
static const Rule rules[] = {
	...
	RULE(.class = "Chromium", .tags = 1 << 0, .switchtag = 1)
	RULE(.class = "Code", .tags = 1 << 1, .switchtag = 1)
	RULE(.class = "Emacs", .tags = 1 << 1, .switchtag = 1)
	RULE(.class = "st", .tags = 1 << 2, .switchtag = 1)
	RULE(.class = "Alacritty", .tags = 1 << 2, .switchtag = 1)
	RULE(.class = "UnityHub", .tags = 1 << 3, .switchtag = 1, .isfloating = 1)
	RULE(.class = "Discord", .tags = 1 << 3, .switchtag = 1)
	RULE(.class = "Thunar", .tags = 1 << 4, .switchtag = 1)
	RULE(.class = "pl.skmedix.bootstrap.Bootstrap", .tags = 1 << 6, .switchtag = 1, .isfloating = 1)
	RULE(.class = "Stardew Valley", .tags = 1 << 6, .switchtag = 1)
	RULE(.class = "krita", .tags = 1 << 8, .switchtag = 1, .isfloating = 1)
	RULE(.class = "vlc", .tags = 1 << 8, .switchtag = 1)
	RULE(.class = "obs", .tags = 1 << 8, .switchtag = 1, .isfloating = 1)
	RULE(.class = "mpv", .tags = 1 << 8, .switchtag = 1)
	RULE(.class = "mplayer", .tags = 1 << 8, .switchtag = 1)
	RULE(.class = "Gimp", .tags = 1 << 8, .switchtag = 1, .isfloating = 1)
...
static const BarRule barrules[] = {
	...
	#if BAR_STATUSBUTTON_PATCH
	{ -1,        -1,     BAR_ALIGN_LEFT,   width_stbutton,          draw_stbutton,          click_stbutton,          "statusbutton" },
	#endif // BAR_STATUSBUTTON_PATCH
	#if BAR_POWERLINE_TAGS_PATCH
	{  0,        -1,     BAR_ALIGN_LEFT,   width_pwrl_tags,         draw_pwrl_tags,         click_pwrl_tags,         "powerline_tags" },
	#endif // BAR_POWERLINE_TAGS_PATCH
	#if BAR_TAGS_PATCH
	{ -1,        -1,     BAR_ALIGN_LEFT,   width_tags,              draw_tags,              click_tags,              "tags" },
	#endif // BAR_TAGS_PATCH
	#if BAR_TAGLABELS_PATCH
	{ -1,        -1,     BAR_ALIGN_LEFT,   width_taglabels,         draw_taglabels,         click_taglabels,         "taglabels" },
	#endif // BAR_TAGLABELS_PATCH
	#if BAR_TAGGRID_PATCH
	...
	{ statusmon, -1,     BAR_ALIGN_RIGHT,  width_statuscolors,      draw_statuscolors,      click_statuscmd,         "statuscolors" },
	#elif BAR_STATUSCOLORS_PATCH
	{ statusmon, -1,     BAR_ALIGN_RIGHT,  width_statuscolors,      draw_statuscolors,      click_statuscolors,      "statuscolors" },
	#elif BAR_STATUS2D_PATCH && BAR_STATUSCMD_PATCH
	{ statusmon, -1,     BAR_ALIGN_RIGHT,  width_status2d,          draw_status2d,          click_statuscmd,         "status2d" },
	#elif BAR_STATUS2D_PATCH
	{ statusmon, -1,     BAR_ALIGN_RIGHT,  width_status2d,          draw_status2d,          click_status2d,          "status2d" },
	#elif BAR_POWERLINE_STATUS_PATCH
	{ statusmon, -1,     BAR_ALIGN_RIGHT,  width_pwrl_status,       draw_pwrl_status,       click_pwrl_status,       "powerline_status" },
	#elif BAR_STATUS_PATCH && BAR_STATUSCMD_PATCH
	{ statusmon, -1,     BAR_ALIGN_RIGHT,  width_status,            draw_status,            click_statuscmd,         "status" },
	#elif BAR_STATUS_PATCH
	{ statusmon, -1,     BAR_ALIGN_RIGHT,  width_status,            draw_status,            click_status,            "status" },
	#endif // BAR_STATUS2D_PATCH | BAR_STATUSCMD_PATCH
	#if XKB_PATCH
	{  0,        -1,     BAR_ALIGN_RIGHT,  width_xkb,               draw_xkb,               click_xkb,               "xkb" },
	#endif // XKB_PATCH
	#if BAR_FLEXWINTITLE_PATCH
	{ -1,        -1,     BAR_ALIGN_NONE,   width_flexwintitle,      draw_flexwintitle,      click_flexwintitle,      "flexwintitle" },
	...
	{ -1,        -1,     BAR_ALIGN_NONE,   width_fancybar,          draw_fancybar,          click_fancybar,          "fancybar" },
