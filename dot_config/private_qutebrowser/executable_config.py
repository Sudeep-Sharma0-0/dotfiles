...
# Type: QtColor
c.colors.tabs.selected.odd.bg = '#2D802D'

# Background color of selected even tabs.
# Type: QtColor
c.colors.tabs.selected.even.bg = '#2D802D'
...
# Type: QtColor
c.colors.tabs.pinned.selected.odd.bg = '#2D802D'

# Background color of pinned selected even tabs.
# Type: QtColor
c.colors.tabs.pinned.selected.even.bg = '#2D802D'
...
config.bind('M', 'hint links spawn mpv {hint-url} --force-window=immediate')
